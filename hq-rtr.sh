...
network 192.168.23.0/26 area 0
network 192.168.23.64/28 area 0
network 192.168.23.80/29 area 0
...
ip nat outside
exit
ip nat pool NAT_POOL 192.168.23.1-192.168.23.62,192.168.23.65-192.168.23.78,192.168.23.81-192.168.23.87
ip nat source dynamic inside-to-outside pool NAT_POOL overload interface int0
ip pool cli_pool 1 
range 192.168.23.66-192.168.23.78
exit
dhcp-server 1
pool cli_pool 1
mask 28
...
exit
ntp timezone utc+4
ip nat source static tcp 192.168.23.62 2024 172.16.4.14 2024
security none
exit
wr mem
